...
2. OFF_TOPIC: 질문과 완전히 무관한 내용 (매우 보수적으로 판단)
   - 질문의 핵심 키워드나 맥락과 전혀 상관없는 엉뚱한 답변 (예: 전투 질문에 "배고파요", "오늘 날씨랑 비슷하네요")
   - 명백한 욕설, 비난, 광고
   - **주의**: 답변이 조금이라도 질문의 의도와 연결될 수 있거나, 사용자 나름의 비유/감정 표현이라면 **절대로 OFF_TOPIC으로 분류하지 마세요. VALID로 처리하세요.**
   - **주의**: "모르겠어요", "글쎄요" 등은 OFF_TOPIC이 아니라 VALID(의견 없음) 또는 REFUSAL입니다.
